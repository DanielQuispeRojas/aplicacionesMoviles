package com.example.proyreclirview;
...
public class MainActivity extends AppCompatActivity {
    String []nombres = {"Anticucho", "Bistec", "ceviche", "CuyFrito", "Huancaina", "Juane", "Mondongo", "Pachamanca"};
    float []precios = {14, 35, 30, 40, 12,35,18,32};

    int []fotos = {R.drawable.anticucho, R.drawable.bistec, R.drawable.ceviche, R.drawable.cuy, R.drawable.papahuancaina, R.drawable.juane, R.drawable.mondongo, R.drawable.pachamanca};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rv1 = findViewById(R.id.reciclerView);
    ...
    private class AdaptadorPlatos extends RecyclerView.Adapter<AdaptadorPlatos.AdaptadorPlatosHolder> {
        ...
        private class AdaptadorPlatosHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
            ...
            public void imprimir(int position){
                ...
                tv1.setText(String.valueOf(precios[position]));
